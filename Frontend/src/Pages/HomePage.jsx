      ...
      <div className='sm:max-w-[1280px] w-full px-6 sm:px-16 my-12 flex flex-col gap-12'>
        ...
        <div className='grid sm:grid-cols-3 grid-cols-1 gap-8'>
          ...
          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
            ...
            <p className='text-[16px] text-gray-200'>Personalized dashboards for Students, Teachers, Admins, and Guests with distinct functionalities.</p>
          </div>

          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
              <p className='text-white'>[GIF/Image: Google Sheets + Charts]</p>
            </div>
            <h3 className='text-[22px] text-[#9ee174] font-semibold mb-2'>Live Data Visualization</h3>
            <p className='text-[16px] text-gray-200'>Integrated Google Sheets API and Chart.js for real-time performance analytics and progress tracking.</p>
          </div>

          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
              <p className='text-white'>[GIF/Image: Secure Auth]</p>
            </div>
            <h3 className='text-[22px] text-[#9ee174] font-semibold mb-2'>Secure Authentication</h3>
            <p className='text-[16px] text-gray-200'>JWT-based authentication and authorization ensure data security with smooth user access control.</p>
          </div>

          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
              <p className='text-white'>[GIF/Image: Scheduling + Notices]</p>
            </div>
          ...
          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
              <p className='text-white'>[GIF/Image: Admin Panel]</p>
            </div>
          ...
          <div className='border-2 border-[#545454] rounded-[20px] p-6 flex flex-col items-center text-center shadow-lg bg-black/40'>
            <div className='w-full h-[200px] rounded-md bg-gray-700 mb-4 flex items-center justify-center'>
              <p className='text-white'>[GIF/Image: Guest Access]</p>
            </div>
            <h3 className='text-[22px] text-[#9ee174] font-semibold mb-2'>Guest Learning</h3>
            <p className='text-[16px] text-gray-200'>Guests can access free resources and explore learning content before signing up.</p>
          </div>
        </div>
      </div>
