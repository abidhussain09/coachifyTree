  ...
  return (
    <div className='flex flex-col items-center justify-center h-auto gap-4 p-4 w-full'>
      <div className='flex basis-1/12 w-full gap-2'>
        ...
        <div className='rounded-xl sm:rounded-[20px] bg-[#63a73a] basis-8/12 text-base sm:text-2xl flex justify-center items-center p-2'>
          <div>Syllabus</div>
      ...
      <div className='flex basis-11/12 w-full gap-2 flex-col'>
        {testData.map((test, index) => (
          <div key={index} className='flex text-xs sm:text-lg itim text-start gap-2 overflow-auto'>
            ...
            <div className='rounded-xl sm:rounded-[20px] bg-neutral-800 basis-8/12 p-2 sm:p-4 text-wrap'>
              {test.syllabus}
            </div>
