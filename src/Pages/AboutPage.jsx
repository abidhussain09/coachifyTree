...
export const AboutPage = () => {
  return (
    ...
    <div className='flex flex-col items-start '>
      <div className='text-6xl itim mb-10 text-[#D8973C] text-start'>About Us</div>
      <div className='text-2xl itim mb-10 max-w-[80%] text-start'>
      ...
      <div className='text-6xl itim mb-10 text-[#D8973C] text-start'>Mission Statement</div>
      <div className='text-2xl itim mb-10 max-w-[80%] text-start'>
      ...
      <div className='text-5xl itim mb-10 text-[#D8973C] text-start'>Coachify Tree offers specialized branches:</div>
      <div className='text-2xl itim max-w-[80%] text-start'>
